...
ALTER TABLE "blue_hydra_sync_versions" RENAME TO "tmp_sync_versions";
...
INSERT INTO "blue_hydra_sync_versions" (
"id",
"version" 
) SELECT
"id",
"version" 
FROM tmp_sync_versions;

DROP TABLE tmp_devices;
DROP TABLE tmp_sync_versions;
END;
